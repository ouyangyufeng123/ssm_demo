...
public class StudentServiceImpl implements StudentService {
    ...
    public List<Student> selectByStudent(Long sid, String sname, Integer sage) {
        ...
        //根据sname条件查询
        if (sname != null) {
            example.createCriteria().andSnameEqualTo(sname);
        }

        //根据sage条件查询
        if (sage != null) {
            example.createCriteria().andSageEqualTo(sage);
        }
    ...
    public void insertStudent(Student stu) {
        try {
            ...
            LOGGER.error("添加失败! stu--->" + stu + "; 错误信息--->" + ex.toString());
    ...
    public void deleteStudent(Long sid) {
        try {
            ...
            LOGGER.error("删除失败! sid--->" + sid + "; 错误信息--->" + ex.toString());
    ...
    public void updateStudent(Student stu) {
        try {
            ...
            LOGGER.error("修改失败! stu--->" + stu + "; 错误信息--->" + ex.toString());
